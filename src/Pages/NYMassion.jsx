...
import {prop4} from '../assets'

const Sanfra = () => {
  return (
    <Section className='mt-12 container'>
     <div className="w-full ">
       <img src={prop4}  className="w-full h-60 max-md:hidden "/>
     </div>
     ...
     <div className='flex mt-12 w-full gap-16 flex-wrap  '>
      <div  className="flex flex-col w-full lg:w-6/12 xl:w-8/12 ">
          <p className="text-n-1/75 text-xl font-old">New York, NY, USA</p>
          <h2 className='text-4xl font-bebas font-bold mt-4'>New York Mansion</h2>
     ...
     <div className="">
       <Contact title='Property for sale'>$1,250,000 USD</Contact>
      </div>
     </div>   
