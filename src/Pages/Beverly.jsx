...
import {prop2} from '../assets'

const Sanfra = () => {
  return (
    <Section className='mt-12 container'>
     <div className="w-full ">
       <img src={prop2}  className="w-full h-60 max-md:hidden "/>
     </div>
     ...
     <div className='flex mt-12 w-full gap-16 flex-wrap  '>
      <div  className="flex flex-col w-full lg:w-6/12 xl:w-8/12 ">
          <p className="text-n-1/75 text-xl font-old">Los Angeles, CA, USA</p>
          <h2 className='text-4xl font-bebas font-bold mt-4'>Beverly Hills Mansion</h2>
     ...
     <div className="">
       <Contact title='Property for rent'>$12,000,000 USD</Contact>
      </div>
     </div>   
