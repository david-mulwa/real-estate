...
import {prop6} from '../assets'

const Sanfra = () => {
  return (
    <Section className='mt-12 container'>
     <div className="w-full ">
       <img src={prop6}  className="w-full h-60 max-md:hidden "/>
     </div>
     ...
     <div className='flex mt-12 w-full gap-16 flex-wrap  '>
      <div  className="flex flex-col w-full lg:w-6/12 xl:w-8/12 ">
          <p className="text-n-1/75 text-xl font-old">Washington, DC, USA</p>
          <h2 className='text-4xl font-bebas font-bold mt-4'>Presidential Suite DC</h2>
     ...
     <div className="">
       <Contact title='Property for rent'>$ 10,000,000</Contact>
      </div>
     </div>   
