  ...
  return (
    <Section className='mt-12 container'>
     <div className="w-full ">
       <img src={prop5}  className="w-full h-60 max-md:hidden "/>
     </div>
     ...
     <div className='flex mt-12 w-full gap-16 flex-wrap  '>
      <div  className="flex flex-col w-full lg:w-6/12 xl:w-8/12 ">
          ...
          <h2 className='text-4xl font-bebas font-bold mt-4'>New York Penthouse</h2>
     ...
     <div className="">
       <Contact title='Property for rent'>$2,500,000 USD</Contact>
      </div>
     </div>   
